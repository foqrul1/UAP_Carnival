...
if(isset($_REQUEST['del_id']) && $_REQUEST['del_id'] !=""){
    ...
    if(!$delcouse){
        echo "<script>window.location='admin_complain_list.php'</script>";
    }
}
    ...
    <div class="row" style="padding-top: 20px;">
      ...
      <div class="col-6">
        <ul class="nav nav-tabs" style=" border-bottom: 0px; float: right;">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="admin_complain_list.php">Complain Box</a>
          </li>
          <li class="nav-item">
   ...
   <div class="bodycontainer">
    ...
    <div class="col-3" style="border-right: 1px solid #ccc; max-width: 20%;">
      ...
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link active" id="v-pills-messages-tab" data-toggle="pill" href="admin_complain_list.php" role="tab" aria-controls="v-pills-messages" aria-selected="false">Complain Box</a>
      ...
      <table class="table table-bordered" style="border-color: #000;background-color: #f8f9fa;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a class="btn btn-danger" href="admin_complain_list.php?del_id=<?php echo $row['id']?>">Delete</a></td>
          </tr>
