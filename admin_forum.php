...
if (isset($_POST['comment'])) {
    ...
    $created_date   = date('Y-m-d');
     ...
     $query ="INSERT INTO forum(name,created_date,post) VALUES('$user_name','$created_date','$text_comment')";
  ...
  <div class="row">
    <div class="col-12" >
      <table class="table table-bordered" style="border-color: #000;background-color: #f8f9fa;">
        ...
        <tbody>
          <?php 
          $query = "SELECT * FROM forum ORDER BY created_date DESC";
          $result = mysqli_query($conn,$query);
          $sn=1;
          ...
          <tr>
            ...
            <td><a class="btn btn-info" href="admin_forum_ex.php?act=del&id=<?php echo $row['id']?>">Go to</a></td>
          </tr>
