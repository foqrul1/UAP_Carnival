 <?php  
  ...
  if(isset($_POST['update']) && $_POST['fullname'] !=""){
    ...
    $query = "UPDATE users SET name='$fullname', contactno='$contactno',emailid='$emailid',password='$password',address='$address' WHERE id ='$id'";
   ...
   <div class="bodycontainer">
     <div class="row" style=" height: 500px;">
      ...
      <div class="col-9"><h1>Update Profile
        <span style="float: right"><a href="user_dashboard.php">Back</a></span>
      </h1> 
