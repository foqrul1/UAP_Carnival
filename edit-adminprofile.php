 <?php  
  ...
  if(isset($_POST['update']) && $_POST['fullname'] !=""){
    ...
    $query = "UPDATE admin SET name='$fullname', contactno='$contactno',emailid='$emailid',password='$password',address='$address'WHERE id ='$id'";
     ...
     <div class="row" style=" height: 500px;">
      ...
      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        if(isset($_SESSION['id']) && $_SESSION['id'] !=''){ ?>
            ...
            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="forum.php" role="tab" aria-controls="v-pills-messages" aria-selected="false">Forum</a>

          <?php } ?>
      </div>
    </div>
      <div class="col-9"><h1>Update Profile
        <span style="float: right"><a href="admin-dashboard.php">Back</a></span>
      </h1> 
        <form method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?php echo $row['id']?>">
            ...
            <div class="col-2" style="float: right;">
              <input type="submit" name="update" class="btn btn-info" value="Update"  style="margin-top: 20px; background-color: #179b77;border-color:#179b77" >
              </div>
              </form>
</div>
